...
test -z "$ACCUMULO_MONITOR_OPTS" && export ACCUMULO_MONITOR_OPTS="${POLICY} -Xmx128m -Xms128m"
...
export LD_LIBRARY_PATH=/home/ubuntu/leo/hadoop-2.7.3/lib/native:${LD_LIBRARY_PATH}
